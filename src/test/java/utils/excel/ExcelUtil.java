...
public class ExcelUtil {
    ...
    public static void setExcelFileSheet(String sheetName) throws IOException {
        ...
        // Open the Excel file
        FileInputStream ExcelFile = new FileInputStream(testDataExcelPath + testDataExcelFileName); //load the file
        excelWBook = new XSSFWorkbook(ExcelFile); //new Excel file
        excelWSheet = excelWBook.getSheet(sheetName); //get the Excel sheet
    }
